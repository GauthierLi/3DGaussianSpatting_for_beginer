...
class GaussianModels:
    def __init__(self, sh_degrees: int, optimizer_type: str="default", cam_infos: List[Camera]=[]):
    ...
    def create_from_pcd(self, pcd:BasicPointCloud, cam_infos: int, spatial_lr_scale: float):
        ...
        features = torch.zeros((fused_color.shape[0], 3, (self.max_sh_degrees + 1) ** 2)).float().cuda()
